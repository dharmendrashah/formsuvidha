    <link type="text/css" rel="stylesheet" href="assets/custom/task.css" media="screen,projection" />
  ...
  <div class="main">
    <div class="nav">
      ...
      <div class="menu">
        ...
        <ul>
          <li> <a href="admin.php?admin=admin/home"><i class="fa fa-home"></i>Home</a></li>
