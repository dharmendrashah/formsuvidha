    ...
    <nav class="light-blue lighten-1" role="navigation">
        <div class="nav-wrapper"><a id="logo-container" href="index.php" class="brand-logo"
            ...
            <ul class="right hide-on-med-and-down">
                            <li>
                <a href="/">
                <span class="fa fa-user-circle-o" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;<?php echo $admin['rights']; ?>
                </a>
                </li>
                <li>
                <a href="admin.php?admin=admin/home">
                <span class="fa fa-user-circle-o" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;<?php echo $admin['first_name']." ".$admin['lastname']; ?>
                </a>
                </li>
