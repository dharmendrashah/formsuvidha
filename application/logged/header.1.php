    ...
    <nav class="light-blue lighten-1" role="navigation">
        <div class="nav-wrapper"><a id="logo-container" href="index.php" class="brand-logo"
            ...
            <ul class="right hide-on-med-and-down">
                <li><a href="index.php?get=alldata/&&username=<?php echo $detail['username']; ?>">
                <span class="fa fa-user-circle-o" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;<?php echo $detail['first_name']." ".$detail['last_name']; ?></a></li>
