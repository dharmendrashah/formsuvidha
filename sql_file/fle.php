    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_10_marksheet_".$username.".".$fileActualExt;
...
if(isset($_FILES['12m'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_12_marksheet_".$username.".".$fileActualExt;
...
if(isset($_FILES['ugl'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_ug_certificate_".$username.".".$fileActualExt;
...
if(isset($_FILES['pgl'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_pg_certificate_".$username.".".$fileActualExt;
...
if(isset($_FILES['cacer'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_caste_certificate_".$username.".".$fileActualExt;
...
if(isset($_FILES['incer'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_income_certificate_".$username.".".$fileActualExt;
...
if(isset($_FILES['pwdcer'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_pwd_certificate_".$username.".".$fileActualExt;
...
if(isset($_FILES['domcer'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_domicile_certificate_".$username.".".$fileActualExt;
...
if(isset($_FILES['photo'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_pic_".$username.".".$fileActualExt;
...
if(isset($_FILES['sig'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_signature_".$username.".".$fileActualExt;
...
if(isset($_FILES['left_thumb'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."Left_Thumb_".$username.".".$fileActualExt;
...
if(isset($_FILES['right_thumb'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_right_thumb_".$username.".".$fileActualExt;
...
if(isset($_FILES['oth_file'])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            if($fileSize < 100000000000){
                $fileNameNew = uniqid('', true)."_other_file_".$username.".".$fileActualExt;
...
$sql = "INSERT INTO `user_file` (`username`, `10_marksheet`, `12_marksheet`, `ug_marksheet`, `pg_marksheet`, `caste_cerificate`, `income_certificate`, `pwd_certificate`, `domicile_certificate`, `photo`, `signature`, `left_thumb`, `right_thumb`, `other`)
 VALUES ('$user', '$tenfileDestination', '$twelfileDestination', '$ugfileDestination', '$pgfileDestination', '$cacerfileDestination', '$icernfileDestination', '$pwdfileDestination', '$domcerfileDestination', '$picfileDestination', '$sigfileDestination', '$leftfileDestination', '$rightfileDestination', '$othfileDestination')";
if ($conn->query($sql) === TRUE) {

   header("Location: index.php?get=alldata/&&all_the_file_were_uploaded_successfully&&username=".$user);
